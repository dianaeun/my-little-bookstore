        ...
        return (
            <div>
                  ...
                  <tbody>
                    {this.books.map((book) => (    
                      <tr>
                        ...
                        {book.request.length ? <td style={{paddingLeft: "1.1rem", paddingTop: "0.5rem"}}><img src={edit_no} alt="Edit Disabled" style={{ width: "1.5rem", padding: "0rem"}} /></td>
                        ...
                        <td style={{paddingTop: "0.5rem", paddingLeft: "4rem"}}>{this.createRequestsCol(book.request.length)}</td>
                      </tr>
                    ))}
                  </tbody>
                ...
                <thead>
                  ...
                  <tbody>
                    {this.books.filter(function (book){return book.request.length > 0}).map((book) => (
                      <tr>
                        <td>{book.request[0].date}</td>
                        <td>{book.title}</td>
                        <td>{book.request[0].sender}</td>
                        <td>
                          <Button variant="outline-primary" size="sm" style={{marginLeft:"0.2rem"}} disabled>Accept</Button>
                          <Button variant="outline-danger" size="sm" style={{marginLeft:"0.2rem"}} disabled>Decline</Button>
                        </td>
                        <td>
                          Pending
                        </td>
